...
import com.ecommerce.microcommerce.manager.ProductManager;
...
public class ProductController {
    ...
    @ApiOperation(value = "Recupère la marge effectuée par produit")
    ...
    public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
        ...
        if(product.getPrix() <= 0){
            throw new ProduitGratuitException(product.getPrix());
        }
